...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmanagedmachinepooltemplates,verbs=get;list;watch
...
// +kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=awsmanagedcontrolplanetemplates,verbs=get;list;watch;update;patch;delete
